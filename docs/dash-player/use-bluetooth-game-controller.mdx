...
<table>
    ...
    <tbody>
    <tr>
        <td style={{whiteSpace: 'nowrap'}}>Micro 蓝牙手柄</td>
        <td
            onClick={() => {
                window.open('https://www.8bitdo.cn/micro/')
            }}
        ><Image img={require('./img/8bitdo-micro-l.png')}/></td>
    </tr>
    <tr>
        <td style={{whiteSpace: 'nowrap'}}>Zero2 蓝牙手柄</td>
        <td
            onClick={() => {
                window.open('https://www.8bitdo.cn/zero2/')
            }}
        ><Image img={require('./img/8bitdo-zero2-l.png')}/></td>
    </tr>
    </tbody>
</table>
...
<Image img={require('./img/shortcut.png')}/>
